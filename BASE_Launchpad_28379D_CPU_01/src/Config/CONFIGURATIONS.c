...
EALLOW;     // ADCB
    ...
    AdcbRegs.ADCINTSEL1N2.bit.INT1SEL = 4;     // end of SOC6 will set INT1 flag
...
EALLOW;     // ADCC
    ...
    AdccRegs.ADCINTSEL1N2.bit.INT1SEL = 4;     // end of SOC6 will set INT1 flag
